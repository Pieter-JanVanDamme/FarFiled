...
import be.pjvandamme.farfiled.model.AdorableAvatarFeatures
...
private const val BASE_URL = "https://api.adorable.io/"
...
object AdorableAvatarApi{
    val retrofitService: AdorableAvatarApiService by lazy{
        retrofit.create(AdorableAvatarApiService::class.java)
    }
}